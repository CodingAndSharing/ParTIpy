...
[![Documentation Status](https://readthedocs.org/projects/partipy-dev/badge/?version=01_docspass)](https://partipy-dev.readthedocs.io/en/01_docspass/?badge=01_docspass)
...
For detailed information and example tutorials, please refer to our [documentation](https://partipy-dev.readthedocs.io/en/01_docspass/). Key resources include:

- [Quickstart Vignette](https://partipy-dev.readthedocs.io/en/01_docspass/notebooks/quickstart.html)
- [Archetypal Analysis Vignette](https://partipy-dev.readthedocs.io/en/01_docspass/notebooks/archetypal_analysis.html)
...
See the [changelog](https://partipy-dev.readthedocs.io/en/01_docspass/changelog.html).
