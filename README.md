...
[![Documentation Status](https://readthedocs.org/projects/partipy-dev/badge/?version=dev)](https://partipy-dev.readthedocs.io/en/dev/?badge=dev)
...
For detailed information and example tutorials, please refer to our [documentation](https://partipy-dev.readthedocs.io/en/dev/). Key resources include:

- [Quickstart Vignette](https://partipy-dev.readthedocs.io/en/dev/notebooks/quickstart.html)
- [Archetypal Analysis Vignette](https://partipy-dev.readthedocs.io/en/dev/notebooks/archetypal_analysis.html)
...
See the [changelog](https://partipy-dev.readthedocs.io/en/dev/changelog.html).
